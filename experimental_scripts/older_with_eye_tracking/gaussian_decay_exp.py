...
high_value_identity = exp_param.high_value_identity
...
while t < n_trials:
    ...
    if choice == left_key:
        ...
        value_accuracy_list.append(value_accuracy)

        LR_choice_list.append(ord("L"))
        identity_choice_list.append(left_identity)
        ...
        identity_choice_list.append(right_identity)

        point_value = right_key_points

    elif np.isnan(choice):
        LR_choice_list.append(np.nan)
        identity_choice_list.append(np.nan)
        value_accuracy_list.append(np.nan)
    ...
    rt_list.append(rt)
    LR_solution_list.append(LR_solution)
...
# save data
header = (
    "trial, subj_id, run, LR_choice, identity_choice,"  +
    "value_accuracy, LR_solution, reward,"
    + "cumulative_reward, rt, total_trial_time, iti, high_value_identity,"
